...
use App\Repositories\Admin\Client\ClientList\Crud\ClientCrudRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
        ...
        public function register(): void
        {
            ...
            //vpx_attach
            $this->app->bind(abstract: IClientCrudRepository::class, concrete: ClientCrudRepository::class);
