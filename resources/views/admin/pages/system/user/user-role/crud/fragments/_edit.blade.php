                        ...
                        <div class="col-md-4">
                            <div class="card p-2 shadow-card card-border">
                                ...
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" {{(in_array($data['item']?->code,restrictedUserCode())) ? 'readonly':''}} class="form-control" name="code" id="code"  value="{{$data['item']?->code}}">
                                    </div>
                                </div>
